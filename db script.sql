...
/*==============================================================*/
/* Index: DIM_DEPORTE3_FK                                       */
/*==============================================================*/
create  index DIM_DEPORTE3_FK on MODALIDAD (
IDDEPORTE
);
...
/*==============================================================*/
create  index RELATIONSHIP_9_FK on RENDIMIENTO_ATLETICO (
IDMODALIDAD
);
...
alter table RENDIMIENTO_ATLETICO
   add constraint FK_RENDIMIE_RELATIONS_MODALIDA foreign key (IDMODALIDAD)
